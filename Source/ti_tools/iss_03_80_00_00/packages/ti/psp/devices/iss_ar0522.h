 ...
 * \defgroup ISS_DRV_FVID2_DEVICE_VID_ENC_AR0522_API AR0522 Video Encoder API
 *
 *  This modules define API specific to AR0522 video encoder device.
 *
 * @{
*/
 ...
 *  \file iss_ar0522.h
 *
 *  \brief AR0522 Sensor API
*/

#ifndef _ISS_Ar0522_H_
#ifdef __cplusplus
extern "C" {
#endif /* __cplusplus */
#define _ISS_Ar0522_H_
 ...
 */
/**
  * \addtogroup ISS_DRV_FVID2_IOCTL_AR0522
  * @{
*/
...
/**
  ...
  *
*/
#define IOCTL_ISS_AR0522_GET_DETAILED_CHIP_ID      \
...
/**
  ...
  *
*/
#define IOCTL_ISS_AR0522_QUERY_HPD      \
...
/**
  ...
  *
  *
  * \param cmdArgs       [IN]   Pointer to Iss_Ar0522Prms
  * \param cmdArgsStatus [OUT]  NULL
  *
  * \return FVID_SOK on success, else failure.
  *
*/
#define IOCTL_ISS_AR0522_SET_PARAMS      \
...
/**
  ...
  *
*/
#define IOCTL_ISS_AR0522_GET_PARAMS      \
...
typedef struct {
    UInt32 outputType;
    /**< Type of the OUTPUT i.e. HDMI of DVI #Iss_Ar0522OutputType */
} Iss_Ar0522Prms;
