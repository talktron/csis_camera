...
#if defined(WDR_ON) & (defined(IMGS_MICRON_MT9M034) | defined(IMGS_SONY_IMX104) | defined(IMGS_SONY_IMX136)| defined(IMGS_SONY_IMX140) | defined(IMGS_MICRON_AR0331) | defined(IMGS_MICRON_AR0522))
	ISP_WRITE32(isif_reg->CLDCOFST, 0);				// 7/29/22 DAT
#else
