...
static Int32 Iss_platformTI814xSetPinMux(void)
{
    ...
    REG32(CSL_TI814x_CTRL_MODULE_BASE + 0x0A54) = 0xC0001; /* vin0_d10 */
    REG32(CSL_TI814x_CTRL_MODULE_BASE + 0x0A58) = 0xC0020; /* vin0_d11 */
    REG32(CSL_TI814x_CTRL_MODULE_BASE + 0x0A5C) = 0x40001; /* vin0_d12 */
    REG32(CSL_TI814x_CTRL_MODULE_BASE + 0x0A60) = 0xC0080; /* CAM_RESET */
    REG32(CSL_TI814x_CTRL_MODULE_BASE + 0x0A64) = 0xC0020; /* CAM_STROBE */
    REG32(CSL_TI814x_CTRL_MODULE_BASE + 0x0A68) = 0xC0020; /* CAM_SHUTTER */
...
/* Check to differentiate bw CSK and non csk platforms (ex: ipnc) */
#if defined(TI_DM8127_CSK)
	/* Mux setting based on sensor connected */
	#ifdef IMGS_MICRON_AR0331
	REG32(CSL_TI814x_CTRL_MODULE_BASE + 0x0924) = 0xE0001;
	REG32(CSL_TI814x_CTRL_MODULE_BASE + 0x0928) = 0xE0001;
	REG32(CSL_TI814x_CTRL_MODULE_BASE + 0x0A18) = 0xE0040; /* i2c2_scl_mux0 */
	REG32(CSL_TI814x_CTRL_MODULE_BASE + 0x0A1C) = 0xE0040; /* i2c2_sda_mux0 */
	#endif
#else /* All other platform except TI_DM8127_CSK goes here */
	#ifdef IMGS_MICRON_AR0331
	...
	#else /* TODO: check for other sensor if required */
	/* defalut I2C mux selected for DM814X */
	REG32(CSL_TI814x_CTRL_MODULE_BASE + 0x0924) = 0xE0020; /* i2c2_scl_mux0 */
	REG32(CSL_TI814x_CTRL_MODULE_BASE + 0x0928) = 0xE0020; /* i2c2_sda_mux0 */
	#endif
#endif //defined(TI_DM8127_CSK)
#endif
...
/* Check to differentiate bw CSK and non csk platforms (ex: ipnc) */
	...
	#endif
        #ifdef IMGS_MICRON_AR0331
	REG32(CSL_TI814x_CTRL_MODULE_BASE + 0x0924) = 0xE0001; /* i2c2_scl_mux0 */
	REG32(CSL_TI814x_CTRL_MODULE_BASE + 0x0928) = 0xE0001; /* i2c2_sda_mux0 */
